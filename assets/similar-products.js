(() => {
  const products = [
    ...
    { file: "nattokinase200.html", tag: "Wellness", name: "Nattokinase 200 mg", blurb: "Focused support, made with the same quality thinking.", main: "../products/Nattokinase Carton.webp", hover: "../products/all images/p2.png", icon: "fa-heart-pulse" },
    ...
    { file: "dailyvitals.html", tag: "Everyday nutrition", name: "Daily Vitals", blurb: "An easy everyday habit to keep your nutrition on track.", main: "../products/reefit forte c new size.webp", hover: "../products/all images/multivitamin2.png", icon: "fa-sun" },
